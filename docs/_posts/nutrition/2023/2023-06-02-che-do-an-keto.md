...
references: '{
    ...
    "25": {
        ...
        <p><b>Mục tiêu:</b>  Xác định tác động của chế độ ăn ít carbohydrate nghiêm ngặt đối với trọng lượng cơ thể, lượng nước trong cơ thể, năng lượng đưa vào và tiêu hao, kiểm soát đường huyết, độ nhạy insulin và mức lipid ở bệnh nhân béo phì mắc bệnh tiểu đường loại 2.</p>
    ...
    "34": {
        ...
        !* Phương pháp *!
        <p> 14 phụ nữ thừa cân được chẩn đoán mắc PCOS đã trải qua chế độ ăn keto Địa Trung Hải với chiết xuất thực vật (KEMEPHY) trong 12 tuần. Những thay đổi về trọng lượng cơ thể, chỉ số khối cơ thể (BMI), khối lượng mỡ trong cơ thể (FBM), khối lượng cơ nạc (LBM), mô mỡ nội tạng (VAT), insulin, glucose, HOMA-IR, cholesterol toàn phần, lipoprotein mật độ thấp (LDL) , lipoprotein mật độ cao (HDL), chất béo trung tính (TGs), testosterone toàn phần và tự do, hormone tạo hoàng thể (LH), hormone kích thích nang trứng (FSH); dehydroepiandrosterone sulfate (DHEA), estradiol, progesterone, globulin liên kết hormone giới tính (SHBG) và điểm Ferriman Gallwey đã được đánh giá. </p>
        !* Kết quả *!
        <p> Sau 12 tuần, các phép đo nhân trắc học và thành phần cơ thể cho thấy trọng lượng cơ thể giảm đáng kể (- 9,43 kg), BMI (- 3,35), FBM (8,29 kg) và VAT. Có sự giảm nhẹ đáng kể của LBM. Đã quan sát thấy nồng độ glucose và insulin trong máu giảm đáng kể, cùng với sự cải thiện đáng kể của HOMA-IR. Sự giảm đáng kể của chất béo trung tính, cholesterol toàn phần và LDL cũng được quan sát cùng với sự gia tăng mức HDL. Tỷ lệ LH/FSH, LH toàn phần và testosterone tự do cũng như nồng độ DHEAS trong máu cũng giảm đáng kể. Estradiol, progesterone và SHBG tăng. Điểm Ferriman Gallwey giảm nhẹ, mặc dù không đáng kể. </p>
        !* Kết luận *!
        <p> Kết quả của chúng tôi cho thấy rằng keto có thể được coi là phương pháp điều trị không dùng thuốc có giá trị đối với PCOS. Cần thử nghiệm thời gian điều trị dài hơn để xác minh tác dụng của keto đối với các khía cạnh da liễu của PCOS. </p>"
    },
    "35": {
        "title": "Tiềm năng điều trị chung của chuyển hóa ketone não trong chấn thương sọ não",
        "author": "Mayumi L Prins, Joyce H Matsumoto",
        "year": 2014,
        "source": "https://pubmed.ncbi.nlm.nih.gov/24721741/",
        "abstract": "Giai đoạn sau chấn thương do suy giảm chuyển hóa glucose đi kèm với tình trạng giảm adenosine triphosphate, tăng glucose thông qua con đường pentose phosphate, sản xuất gốc tự do, kích hoạt poly-ADP ribose polymerase thông qua tổn thương DNA và ức chế glyceraldehyd dehydrogenase (một loại enzyme glycolytic chủ chốt) thông qua sự cạn kiệt của nhóm NAD tế bào. Trong khi quá trình chuyển hóa glycolytic bị suy yếu sau chấn thương não, glucose trở thành chất nền năng lượng kém thuận lợi hơn. Ngoài glucose, thể ketone là chất nền thay thế tự nhiên duy nhất được biết đến trong quá trình chuyển hóa năng lượng của não. Mặc dù người ta đã chứng minh rằng các loại nhiên liệu khác (pyruvate, lactate và acetyl-L-Carnitine) có thể được não chuyển hóa, nhưng ketone là nhiên liệu nội sinh duy nhất có thể đóng góp đáng kể vào quá trình chuyển hóa của não. Các nghiên cứu tiền lâm sàng sử dụng chế độ ăn keto cả trước và sau chấn thương đã chứng minh sự cải thiện cả về cấu trúc lẫn chức năng trong các mô hình chấn thương sọ não, mô hình chấn động não nhẹ và chấn thương tủy sống. Cần có nhiều nghiên cứu lâm sàng hơn để xác định phương pháp tối ưu nhằm tạo ra sự chuyển hóa ketone ở não sau chấn thương và nghiên cứu thêm về lợi ích bảo vệ thần kinh của liệu pháp keto ở người."
    },
    "36": {
        "title": "Tình trạng ketosis sau khi uống dầu dừa và axit caprylic – có và không có glucose: một nghiên cứu chéo ở người lớn tuổi khỏe mạnh",
        "author": "Jakob Norgren, Shireen Sindi, Anna Sandebring-Matton, Ingemar Kåreholt, Makrina Daniilidou, Ulrika Akenine, Karin Nordin, Staffan Rosenborg, Tiia Ngandu, Miia Kivipelto",
        "year": 2020,
        "source": "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7175812/",
        "abstract": "<p><b> Giới thiệu:</b> Triglyceride chuỗi trung bình (MCT), được hình thành bởi các axit béo có chiều dài 6–12 nguyên tử carbon (C6–C12), chiếm khối lượng khoảng 2/3 trong dầu dừa (Coc). MCT có các đặc tính trao đổi chất cụ thể khiến chúng được mô tả là có tính chất keto ngay cả khi không hạn chế carbohydrate. Tác dụng này chủ yếu được chứng minh đối với axit caprylic (C8), chiếm khoảng 6–8% dầu dừa. Mục đích của chúng tôi là định lượng tình trạng ketosis và đường huyết sau khi uống Coc và C8, có và không có lượng glucose. Dầu hướng dương (Suf) được sử dụng làm chất kiểm soát, dự kiến sẽ không phá vỡ trạng thái ketosis. </p>
        <p><b> Phương pháp:</b> Trong thiết kế nghiên cứu chéo 6 nhánh, 15 tình nguyện viên khỏe mạnh—độ tuổi 65–73, 53% là phụ nữ—được thử nghiệm mỗi tuần một lần. Sau 12 giờ nhịn ăn, xeton được đo trong 4 giờ sau khi uống cà phê với kem, kết hợp với từng nhánh can thiệp theo thứ tự ngẫu nhiên: 1. Suf (30 g); 2. C8 (20g) + Suf (10g); 3. C8 (20g) + Suf (10g) + Glucose (50g); 4. Coc (30 g); 5. Coc (30 g) + Glucose (50 g); 6. C8 (20g) + Coc (30g). Kết quả chính là nồng độ tuyệt đối trong máu của ketone β-hydroxybutyrate, diện tích dưới đường cong (AUC). ANOVA cho các biện pháp lặp lại đã được thực hiện để so sánh các nhánh. </p>
        <p><b> Kết quả:</b> β-hydroxybutyrate, AUC/lần (trung bình ± SD), đối với nhóm các nhánh 1: 0,18 ± 0,11; 2: 0,45 ± 0,19; 3: 0,28 ± 0,12; 4: 0,22 ± 0,12; 5: 0,08 ± 0,04; 6: 0,45 ± 0,20 (mmol/L). Sự khác biệt là đáng kể (tất cả p ≤ 0,02), ngoại trừ nhóm 2 so với 6 và 4 so với 1 & 3. Đường huyết ổn định ở nhóm 1, 2, 4 và 6, ở mức thấp hơn một chút so với mức cơ bản (p ≤ 0,05) tại tất cả các mốc thời gian từ 1–4 giờ sau khi tiêu thụ. </p>
        <p><b> Kết luận:</b> C8 có tác dụng tạo ketone cao hơn các thành phần khác. Coc không khác biệt đáng kể so với Suf hoặc C8 với glucose. Ngoài ra, chúng tôi báo cáo rằng khoảng thời gian 16 giờ không tiệu thụ carbohydrate đã góp phần gây ra tình trạng ketosis nhẹ, trong khi lượng đường trong máu vẫn ổn định. Kết quả của chúng tôi cho thấy rằng việc cho ăn carbohydrate có giới hạn thời gian có thể tối ưu hóa quá trình ketosis khi dùng MCT. </p>"
    },
    "37": {
        "title": "Tỷ lệ thiếu vi chất dinh dưỡng trong các kế hoạch ăn kiêng phổ biến",
        "author": "Jayson B Calton",
        "year": 2010,
        "source": "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2905334/",
        "abstract": "!*1 Bối cảnh 1*!
        <p> Nghiên cứu đã chỉ ra rằng thiếu vi chất dinh dưỡng có mối liên hệ khoa học với nguy cơ thừa cân/béo phì cao hơn cũng như các bệnh nguy hiểm khác. Với hơn hai phần ba dân số Hoa Kỳ thừa cân hoặc béo phì và nghiên cứu cho thấy rằng một phần ba đang ăn kiêng tại bất kỳ thời điểm nào, cần phải xác định xem liệu các kế hoạch ăn kiêng phổ biến hiện nay có cung cấp đủ mức tối thiểu 27 vi chất dinh dưỡng, được xác định theo hướng dẫn Tham khảo Lượng tiêu thụ hàng ngày (RDI) của Cơ quan Quản lý Thực phẩm và Dược phẩm Hoa Kỳ (FDA). </p>
        !* Phương pháp *!
        <p> Thực đơn hàng ngày được đề xuất từ bốn kế hoạch ăn kiêng phổ biến (Atkins for Life, South Beach, DASH, và Địa Trung Hải) đã được đánh giá. Hàm lượng calo và vi chất dinh dưỡng trong từng thành phần trong mỗi bữa ăn được xác định bằng cách sử dụng dữ liệu thành phần thực phẩm từ Cơ sở dữ liệu dinh dưỡng tiêu chuẩn của Bộ Nông nghiệp Hoa Kỳ. Kết quả được đánh giá về mức độ đầy đủ và tổng lượng calo, từ đó các vi chất dinh dưỡng bị thiếu đã được xác định. Các kế hoạch ăn kiêng không đáp ứng đầy đủ 100% theo hướng dẫn của RDI cho từng vi chất trong số 27 vi chất dinh dưỡng đã được phân tích lại; (1) để xác định lượng calo đủ vi chất dinh dưỡng cho tất cả 27 vi chất dinh dưỡng và (2) để xác định lượng calo đủ vi chất dinh dưỡng thứ hai khi lượng vi chất dinh dưỡng thấp hoặc không tồn tại bị loại khỏi yêu cầu đầy đủ. </p>
        !* Kết quả *!
        <p> Phân tích xác định rằng cả bốn kế hoạch ăn kiêng phổ biến đều không cung cấp đủ RDI tối thiểu cho tất cả 27 vi chất dinh dưỡng được phân tích. Trung bình, bốn kế hoạch ăn kiêng được cho là có đủ RDI với (11,75 ± 2,02; trung bình ± SEM) trong 27 vi chất dinh dưỡng được phân tích và chứa (1748,25 ± 209,57) kcal. Phân tích sâu hơn về bốn chế độ ăn kiêng cho thấy rằng cần phải có lượng calo trung bình (27.575 ± 4660,72) để đạt được đủ tất cả 27 vi chất dinh dưỡng. Sáu vi chất dinh dưỡng (vitamin B7, vitamin D, vitamin E, crom, iốt và molypden) được xác định là luôn thấp hoặc không tồn tại trong cả bốn chế độ ăn. Sáu vi chất dinh dưỡng này đã được loại bỏ khỏi yêu cầu đầy đủ và phân tích bổ sung về bốn chế độ ăn đã được tiến hành. Người ta xác định rằng hàm lượng calo trung bình (3.475 ± 543,81) là cần thiết để đạt đủ 100% trong 21 vi chất dinh dưỡng còn lại. </p>
        !* Kết luận *!
        <p> Những phát hiện này rất có ý nghĩa và chỉ ra rằng một cá nhân tuân theo kế hoạch ăn kiêng phổ biến như được đề xuất, chỉ với thực phẩm, có khả năng cao bị thiếu vi chất dinh dưỡng; một trạng thái được chứng minh là có liên quan về mặt khoa học với việc gia tăng nguy cơ mắc nhiều tình trạng sức khỏe và bệnh tật nguy hiểm. </p>"
    },
    "38": {
        "title": "Cà phê gắn liền với việc giảm mỡ cơ thể ở phụ nữ",
        "author": "Anglia Ruskin University",
        "year": 2020,
        "source": "https://www.sciencedaily.com/releases/2020/05/200513200402.htm",
        "abstract": "Theo một nghiên cứu mới, những phụ nữ uống hai hoặc ba tách cà phê mỗi ngày được phát hiện có tổng lượng mỡ trong cơ thể và bụng thấp hơn so với những người uống ít hơn."
    },
    "39": {
        "title": "Về quá trình chuyển hóa ketone ngoại sinh ở người",
        "author": "Brianna J. Stubbs,1 Pete J. Cox,1 Rhys D. Evans, Peter Santer, Jack J. Miller, Olivia K. Faull, Snapper Magor-Elliott, Satoshi Hiyama, Matthew Stirling, Kieran Clarke",
        "year": 2017,
        "source": "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5670148/",
        "abstract": "<p><b> Bối cảnh và mục tiêu:</b> Hiện nay có mối quan tâm đáng kể đến quá trình chuyển hóa ketone do những lợi ích được báo cáo gần đây của ketosis đối với sức khỏe con người. Để đạt được trạng thái ketosis một cách tự nhiên, cần tuân theo chế độ ăn keto giàu chất béo, ít carbohydrate, nhưng việc tuân thủ chế độ ăn kiêng như vậy có thể khó khăn. Một cách khác để tăng nồng độ D-β-hydroxybutyrate (D-βHB) trong máu là các loại đồ uống ketone, nhưng tác dụng chuyển hóa của ketone ngoại sinh vẫn chưa được biết rõ. Tại đây, những người tình nguyện khỏe mạnh đã tham gia vào ba nghiên cứu trao đổi chất ngẫu nhiên về đồ uống có chứa este xeton (KE); (R)-3-hydroxybutyl (R)-3-hydroxybutyrat, hoặc muối xeton (KS); natri cộng với kali βHB. </p>
        <p><b> Phương pháp và kết quả:</b> Trong nghiên cứu đầu tiên, 15 người tham gia đã uống đồ uống KE hoặc KS cung cấp ~12 hoặc ~24 g βHB. Cả hai loại đồ uống đều làm tăng nồng độ D-βHB trong máu (D-βHB Cmax: KE 2,8 mM, KS 1,0 mM, P < 0,001), nồng độ này trở về mức cơ bản trong vòng 3–4 giờ. Đồ uống KS được phát hiện có chứa 50% đồng phân L-βHB, chất này vẫn tăng cao trong máu trong hơn 8 giờ, nhưng không thể phát hiện được sau 24 giờ. Sự bài tiết qua nước tiểu của cả D-βHB và L-βHB đều <1,5% tổng lượng βHB ăn vào và tỷ lệ với AUC trong máu. D-βHB, chứ không phải L-βHB, được chuyển đổi dần dần thành axeton trong hơi thở. Đồ uống KE làm giảm độ pH trong máu xuống 0,10 và đồ uống KS làm tăng độ pH trong nước tiểu từ 5,7 lên 8,5. Trong nghiên cứu thứ hai, ảnh hưởng của bữa ăn trước khi uống KE đến nồng độ D-βHB trong máu được xác định ở 16 người tham gia. Thức ăn làm giảm D-βHB Cmax trong máu xuống 33% (Cho ăn 2,2 mM, Lúc đói 3,3 mM, P < 0,001), nhưng không làm thay đổi nồng độ acetoacetate hoặc axeton trong hơi thở. Tất cả đồ uống ketone đều làm giảm lượng đường trong máu, nồng độ axit béo tự do và chất béo trung tính, đồng thời có tác dụng tương tự đối với các chất điện giải trong máu (vẫn ở mức bình thường). Trong nghiên cứu cuối cùng, những người tham gia được cho uống KE trong 9 giờ dưới dạng ba ly (n = 12) hoặc truyền qua mũi dạ dày liên tục (n = 4) để duy trì nồng độ D-βHB trong máu lớn hơn 1 mM. Cả đồ uống và dịch truyền đều cho D-βHB AUC giống nhau là 1,3–1,4 mol.min. </p>
        <p><b> Kết luận:</b> Chúng tôi kết luận rằng đồ uống ketone ngoại sinh là một cách thiết thực và hiệu quả để đạt được trạng thái ketosis. </p>"
    },
    "40": {
        "title": "Bổ sung Creatine với quan điểm cụ thể về hiệu suất tập thể dục/thể thao: bản cập nhật",
        "author": "Robert Cooper, Fernando Naclerio, Judith Allgrove, Alfonso Jimenez",
        "year": 2012,
        "source": "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3407788/",
        "abstract": "Creatine là một trong những chất bổ sung tự nhiên phổ biến và được nghiên cứu rộng rãi nhất. Phần lớn các nghiên cứu đã tập trung vào tác động của creatine monohydrate đối với hiệu suất và sức khỏe; tuy nhiên, nhiều dạng creatine khác tồn tại và được bán trên thị trường thực phẩm bổ sung/dinh dưỡng thể thao. Bất kể hình thức nào, kết hợp bổ sung creatine với tập luyện cơ bắp thường xuyên cho thấy khả năng tăng sức mạnh, khối lượng cơ và hình thái cơ hiệu quả hơn so với khi chỉ tập luyện cơ bắp. Creatine có thể có ích trong các phương thức tập luyện khác như chạy nước rút cường độ cao hoặc rèn luyện sức bền. Tuy nhiên, có vẻ như tác dụng của creatine giảm dần khi thời gian tập thể dục tăng lên. Mặc dù không phải tất cả mọi người đều phản ứng tương tự với việc bổ sung creatine, người ta thường chấp nhận rằng việc bổ sung nó làm tăng lượng creatine và thúc đẩy quá trình tái tạo adenosine triphosphate nhanh hơn giữa các bài tập cường độ cao. Những kết quả được cải thiện này sẽ làm tăng hiệu suất và thúc đẩy sự thích ứng trong tập luyện tốt hơn. Nhiều nghiên cứu gần đây cho thấy rằng việc bổ sung creatine với lượng 0,1 g/kg trọng lượng cơ thể kết hợp với rèn luyện cơ bắp sẽ cải thiện khả năng thích ứng khi tập luyện ở cấp độ tế bào và dưới tế bào. Cuối cùng, mặc dù hiện nay việc sử dụng creatine dưới dạng thực phẩm bổ sung qua đường uống được coi là an toàn và hợp đạo đức, nhận thức về sự an toàn không thể được đảm bảo, đặc biệt khi sử dụng trong thời gian dài cho các nhóm đối tượng khác nhau (vận động viên, người ít vận động, bệnh nhân, người năng động, người trẻ hoặc người già)."
    },
    "41": {
        "title": "Bổ sung whey protein giúp tăng cường chuyển hóa protein toàn cơ thể và phục hồi hiệu suất sau khi tập luyện cơ bắp: Một nghiên cứu chéo mù đôi",
        "author": "Daniel W. D. West, Sidney Abou Sawan, Michael Mazzulla, Eric Williamson, Daniel R. Moore",
        "year": 2017,
        "source": "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5537849/",
        "abstract": "Chưa có nghiên cứu nào đo lường đồng thời những thay đổi trong quá trình chuyển hóa protein toàn cơ thể và hiệu suất tập thể dục trong quá trình phục hồi sau một buổi tập cơ bắp nặng nhọc. Mục đích của chúng tôi là xác định xem liệu việc tiêu thụ whey protein có giúp tăng cường cân bằng lượng protein toàn cơ thể và phục hồi hiệu suất tập thể dục trong quá trình phục hồi qua đêm (10 giờ) và 24 giờ sau khi tập luyện cơ bắp toàn cơ thể ở nam giới đã qua tập luyện hay không. Trong một thiết kế chéo mù đôi, 12 người đàn ông được đào tạo (76 ± 8 kg, 24 ± 4 tuổi, 14% ± 5% mỡ cơ thể; trung bình ± độ lệch chuẩn) đã thực hiện bài tập cơ bắp vào buổi tối trước khi tiêu thụ 25 g whey protein (PRO; MuscleTech 100% Whey) hoặc giả dược với lượng năng lượng tương ứng (CHO) ngay sau khi tập thể dục (0 giờ) và lặp lại vào sáng hôm sau (~10 giờ phục hồi). Thử nghiệm ngẫu nhiên thứ ba, được thực hiện bởi cùng những người tham gia, không tập thể dục và không dùng chất bổ sung, được coi là thử nghiệm đối chứng nghỉ ngơi. Những người tham gia ăn [15N]glycine để xác định động học protein toàn cơ thể và cân bằng protein ròng sau 10 và 24 giờ phục hồi. Hiệu suất được đánh giá trước khi tập luyện và vào lúc 0, 10 và 24 giờ phục hồi bằng cách sử dụng một loạt các bài kiểm tra. Cân bằng protein thực có xu hướng cải thiện ở PRO (P = 0,064; kích thước hiệu ứng (ES) = 0,61, PRO so với CHO) trong quá trình phục hồi qua đêm. Trong 24 giờ, cân bằng ròng được tăng cường ở PRO (P = 0,036) nhưng không ở CHO (P = 0,84; ES = 0,69, PRO so với CHO), điều này chủ yếu được điều hòa bằng việc giảm sự phân hủy protein (PRO < CHO; P < 0,01). Bài tập làm giảm số rep tối đa (REP), sức mạnh tối đa (MVC), sức mạnh đỉnh và trung bình cũng như hiệu suất nhảy phản chuyển động (CMJ) ở 0 giờ (tất cả P < 0,05 so với Pre). Sau mốc 10 giờ, khả năng phục hồi MVC (ES = 0,56), sức mạnh trung bình (ES = 0,49) và các biến CMJ (ES: 0,27–0,49) trong PRO được tăng cường với tác dụng từ nhỏ đến vừa phải. Ở thời điểm 24 giờ, việc bổ sung protein đã cải thiện MVC (ES = 0,76) ), REP (ES = 0,44) và sức mạnh đỉnh (ES = 0,55). Tóm lại, việc bổ sung whey protein giúp tăng cường quá trình đồng hóa toàn cơ thể và có thể cải thiện khả năng phục hồi của hiệu suất tập luyện sau một đợt tập luyện cơ bắp vất vả."
    },
    "42": {
        "title": "Tác dụng của việc bổ sung protein đến hiệu suất và khả năng phục hồi trong luyện tập cơ bắp và sức bền",
        "author": "Harry P. Cintineo, Michelle A. Arent, Jose Antonio, Shawn M. Arent",
        "year": 2018,
        "source": "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6142015/",
        "abstract": "Có bằng chứng tốt cho thấy rằng việc tiêu thụ protein trước và/hoặc sau khi tập luyện sẽ làm tăng đáng kể quá trình tổng hợp protein cho cơ. Tuy nhiên, cần lưu ý rằng tổng lượng calo và lượng protein hàng ngày vẫn đóng vai trò quan trọng nhất trong chế độ ăn uống trong việc tạo điều kiện thích ứng với tập thể dục. Tuy nhiên, một khi các yếu tố này được tính đến, có vẻ như lượng protein nạp vào xung quanh thời gian tập luyện, đặc biệt là trong giai đoạn sau tập luyện, đóng một vai trò hữu ích trong việc tối ưu hóa hiệu suất thể chất và ảnh hưởng tích cực đến quá trình phục hồi sau khi rèn luyện cơ bắp hay sức bền. Các yếu tố ảnh hưởng đến lợi ích của việc ăn trước hoặc sau tập luyện bao gồm nhưng không nhất thiết giới hạn ở: tình trạng tập luyện (ví dụ: người mới tập luyện so với người nâng cao hoặc vận động viên giải trí so với vận động viên thi đấu), thời gian tập luyện, số buổi tập luyện mỗi ngày , số sự kiện thi đấu mỗi ngày, v.v. Việc tiêu thụ protein sau khi tập luyện cũng góp phần vào tổng lượng năng lượng và protein hàng ngày của một người. Hơn nữa, bất chấp những đề xuất gần đây rằng một người không “cần” tiêu thụ protein trong khung thời gian ngay sau khi tập luyện (1 giờ hoặc ít hơn), cần nhấn mạnh rằng việc không tiêu thụ gì không mang lại lợi ích gì và thậm chí có thể gây bất lợi. Do đó, dựa trên hiệu quả hoạt động và phục hồi, có vẻ như cách tiếp cận thận trọng là yêu cầu vận động viên tiêu thụ protein sau tập luyện và sau thi đấu."
    }
}'
---
...
Chế độ ăn kiêng keto là một chế độ ăn ít carbohydrate, nhiều chất béo. Nó làm giảm mức đường huyết và mức insulin và chuyển sự trao đổi chất của cơ thể từ carbohydrate sang chất béo và ketone. </div>

<h3>Các loại chế độ ăn keto khác nhau</h3>
Có một số phiên bản khác nhau của chế độ ăn keto, bao gồm:

<b>・Chế độ ăn keto tiêu chuẩn (SKD):</b> Đây là một chế độ ăn ít carbohydrate, protein vừa phải và nhiều chất béo. Thường chứa 70% chất béo, 20% protein và chỉ 10% carbohydrate [9].

<b>・Chế độ ăn keto chu kỳ (CKD):</b> Chế độ ăn kiêng này bao gồm các giai đoạn tái cung cấp carbohydrate cao hơn, ví dụ như 5 ngày ăn kiêng keto sau đó là 2 ngày ăn nhiều carbohydrate.

<b>・Chế độ ăn keto có mục tiêu (TKD):</b> Chế độ ăn kiêng này cho phép bạn thêm carbohydrate xung quanh các buổi tập luyện.

<b>・Chế độ ăn keto nhiều protein:</b> Đây tương tự như chế độ ăn keto tiêu chuẩn, nhưng có thêm nhiều protein hơn. Tỷ lệ thường là 60% chất béo, 35% protein và 5% carbohydrate.
Tuy nhiên, chỉ có chế độ ăn keto tiêu chuẩn và chế độ ăn keto nhiều protein đã được nghiên cứu kỹ lưỡng. Chế độ ăn keto theo chu kỳ hoặc chế độ ăn keto có mục tiêu thường là các phương pháp nâng cao hơn và chủ yếu được sử dụng bởi người tập thể hình hoặc vận động viên.
...
<b>・Bệnh tim mạch.</b> Chế độ ăn keto có thể cải thiện các yếu tố rủi ro như mỡ cơ thể, mức cholesterol HDL (cholesterol tốt), huyết áp và đường huyết [28][29].

<b>・Ung thư.</b> Chế độ ăn kiêng này đang được nghiên cứu như một phương pháp điều trị bổ sung cho ung thư, vì nó có thể giúp làm chậm tăng trưởng khối u. [4][30][31].

<b>・Bệnh Alzheimer.</b> chế độ ăn keto có thể giúp giảm các triệu chứng của bệnh Alzheimer và làm chậm quá trình tiến triển bệnh [5][32].

<b>・Động kinh.</b> Nghiên cứu đã cho thấy chế độ ăn keto có thể giảm đáng kể số lượng cơn động kinh ở trẻ em bị động kinh [3].

<b>・Bệnh Parkinson.</b> Mặc dù cần nhiều nghiên cứu hơn, một nghiên cứu đã tìm thấy rằng chế độ ăn này giúp cải thiện triệu chứng của bệnh Parkinson [33].

<b>・Hội chứng buồng trứng đa nang.</b> Chế độ ăn keto giúp giảm mức độ insulin, mà insulin lại có thể đóng vai trò quan trọng trong hội chứng buồng trứng đa nang [34].

<b>・Chấn thương não.</b> Một số nghiên cứu cho thấy chế độ ăn kiêng này có thể cải thiện kết quả của chấn thương não do va chạm [35].
...
<b>・Thực phẩm có đường:</b> nước ngọt, nước trái cây, sinh tố, bánh ngọt, kem, kẹo, v.v.

<b>・Ngũ cốc hoặc tinh bột:</b> sản phẩm làm từ lúa mạch, gạo, mì, ngũ cốc, v.v.

<b>・Trái cây:</b> tất cả loại trái cây, trừ các loại quả mọng như dâu tây.

<b>・Đậu và hạt:</b> đậu xanh, đậu đỏ, đậu lăng, đậu hòa lan, v.v.

<b>・Các loại củ nhiều carbohydrate:</b> khoai tây, khoai lang, cà rốt, củ cải trắng, v.v.

<b>・Sản phẩm ăn ít chất béo hoặc sản phẩm ăn kiêng:</b> mayonnaise ăn ít chất béo, phô mai ít chất béo, v.v.

<b>・Một số loại gia vị hoặc nước xốt:</b> nước xốt thịt nướng, mù tạt mật ong, nước xốt teriyaki, ketchup, v.v.

<b>・Các loại chất béo không tốt:</b> dầu thực vật đã qua chế biến, mayonnaise, v.v.

<b>・Các loại đồ uống có cồn:</b> bia, rượu vang, rượu mạnh, cocktail.

<b>・Thực phẩm ăn kiêng không chứa đường:</b> kẹo không đường, syrup không đường, pudding, chất làm ngọt, món tráng miệng, v.v.
<div class="summary"><p class="summary-title"> TÓM TẮT </p>
...
<b>・Cá có hàm lượng chất béo cao:</b> cá hồi, cá hồi bạc, cá ngừ, cá thu.

<b>・Trứng:</b> tốt nhất là trứng chăn thả.

<b>・Bơ và kem:</b> tốt nhất là từ bò ăn cỏ.

<b>・Phô mai:</b> phô mai chưa qua xử lý như phô mai cheddar, phô mai dê, phô mai kem, phô mai xanh hoặc mozzarella.

<b>・Hạt và hạt giống:</b> hạnh nhân, óc chó, hạt lanh, hạt bí, hạt chia, v.v.

<b>・Các loại dầu tốt cho sức khỏe:</b> dầu ô liu nguyên chất (extra virgin), và dầu bơ.

<b>・Quả bơ:</b> một loại siêu thực phẩm ít carbohydrate.

<b>・Rau củ ít carbohydrate:</b> rau xanh, cà chua, hành, ớt, v.v.

<b>・Gia vị:</b> muối, tiêu, thảo mộc và gia vị.

<div class="summary"><p class="summary-title"> TÓM TẮT </p>
Dựa chế độ ăn của bạn chủ yếu trên thịt, cá, trứng, bơ, hạt, dầu thực phẩm tốt cho sức khỏe, quả bơ và nhiều loại rau củ ít carbohydrate. Bạn có thể ăn rất nhiều loại thực phẩm ngon và bổ dưỡng trong chế độ ăn keto. Đừng chỉ nghĩ đến thịt và chất béo. Rau củ cũng là một phần quan trọng của chế độ ăn này. </div>
...
<h3>Những gợi ý và mẹo cho chế độ ăn keto</h3>
...
<div class="summary"><p class="summary-title"> TÓM TẮT </p>
Đọc nhãn thực phẩm, lập kế hoạch ăn trước và tự mang thực phẩm khi thăm gia đình và bạn bè có thể làm cho việc duy trì chế độ ăn Keto dễ dàng hơn. </div>

<h3>Mẹo khi ăn ngoài với chế độ ăn Keto</h3>
...
<li> năng lượng và chức năng tinh thần kém </li>
<li> cơn đói tăng lên </li>
<li> vấn đề về giấc ngủ </li>
<li> buồn nôn </li>
<li> khó chịu về tiêu hóa </li>
<li> giảm hiệu suất tập thể dục </li>
...
<b>・Khoáng chất.</b>  Việc thêm muối và các khoáng chất khác có thể quan trọng khi bắt đầu vì sự thay đổi trong cân bằng nước và khoáng chất [37].

<b>・Cafein.</b>  Cafein có thể giúp bạn có nhiều năng lượng trong ngày hơn và giảm mỡ [38].

<b>・Ketone bổ sung.</b>  Giúp tăng mức ketone trong cơ thể [39].

<b>・Creatine.</b>  Creatine mang lại nhiều lợi ích cho sức khỏe. Điều này đặc biệt hữu ích nếu bạn kết hợp chế độ ăn keto với tập thể dục [40].

<b>・Whey protein.</b> Sử dụng nửa muỗng whey protein trong protein shake hoặc sữa chua để tăng lượng protein hấp thụ hàng ngày của bạn. [41][42]

<div class="summary"><p class="summary-title"> TÓM TẮT </p>
Một số bổ sung cụ thể có thể hữu ích trong chế độ ăn Keto. Chúng bao gồm ketone bổ sung, dầu MCT và khoáng chất. </div>